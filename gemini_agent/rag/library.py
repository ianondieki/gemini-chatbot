...
class DocumentLibrary:
    ...
    # --- ingestion -----------------------------------------------------
    def add_pdf(
        self, source: Any, name: str, progress: Optional[Progress] = None
    ) -> int:
        ...
        return self._ingest(
            extracted.text, name, progress, page_spans=extracted.page_spans
        )
    ...
    def _ingest(self, text, name, progress, page_spans) -> int:
        chunks = chunk_text(
            text,
